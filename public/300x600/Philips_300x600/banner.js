...
function setupDom() {
  ...
  creative.dom.copyThree = document.querySelector('.frame-1__copy__three');
  creative.dom.copyFour = document.querySelector('.frame-1__copy__four');
...
function runAnimationLoop() {
  ...
  .to([creative.dom.copyOne, creative.dom.copyTwo, creative.dom.featureImg, creative.dom.copyThree, creative.dom.copyFour], 1, {autoAlpha: 1, x: 0, ease: Power4.easeOut}, '-=.5')
