    ...
    return (
      <div className="project-detail-section">
        <div className="item text-container">
          <h1 ref={h1 => this.projectTitle = h1} className="text-container__title">Liftmaster.com</h1>
          <h1 ref={h1 => this.projectSubTitle = h1} className="text-container__subtitle">HTML5, CSS3, Bootstrap, Meteor/Node.js, Prismic</h1>
          ...
          <a ref={a => this.btn = a} href="https://www.liftmaster.com/" target="_blank" className="button">Visit Liftmaster</a>
        </div>
