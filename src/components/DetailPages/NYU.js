    ...
    return (
      <div className="project-detail-section">
        <div className="item text-container">
          <h1 ref={h1 => this.projectTitle = h1} className="text-container__title">NYU Arts of Sciences</h1>
          ...
          <a ref={a => this.btn = a} href="https://as.nyu.edu/" target="_blank" className="button">Visit NYU</a>
        </div>
